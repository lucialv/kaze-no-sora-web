  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: "identifier-URL", content: "https://kaze-no-sora.mishu.dev" },
        {
          name: "keywords",
        ...
        { name: "shortlink", content: "https://kaze-no-sora.mishu.dev" },
        {
          name: "subject",
          content: "Kaze no Sora Discord Server Website",
        },
        {
          name: "summary",
          content: "Kaze no Sora Discord Server Website",
        },
        { name: "url", content: "https://kaze-no-sora.mishu.dev" },
        {
        ...
        { property: "og:site_name", content: "Kaze no Sora" },
        { property: "og:title", content: "Home | Kaze no Sora" },
        { property: "og:type", content: "website" },
        { property: "og:url", content: "https://kaze-no-sora.mishu.dev" },
